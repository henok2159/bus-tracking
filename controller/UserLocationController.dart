...
import 'package:anbesaye/Model/bus_user.dart';
import 'package:anbesaye/Services/userLocation.dart';
...
class UserLocationController extends GetxController {
  ...
  void addMarker() {
    final MarkerId mi = MarkerId("initialPosition");
  ...
  Future getIcon() async {
    ...
    BitmapDescriptor b = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 3.2), "assets/image/BusIcon.jpg");
    icon.value = b;
    isIconLoaded(true);
  }
}
